...
│                        #   Statistics/ (LibraryStatistics, GameSortComparer)
│                        #   Converters/ (ImageUrl, ReleaseDate, Playtime, EnumDescription, BoolToIndex)
...
└── Bridge.Tests/        # created — 55 tests, all passing (dotnet test Bridge.slnx)
```
