...
- **WPF-UI visual overhaul (Fase 7)** — `FluentWindow` with Mica backdrop, 3-zone title bar (search, view-mode toggles, overflow menu), 52px icon sidebar (Library / Favorites / Sources / Statistics / Settings), themed List/Covers/Details views, and a full-width Statistics overlay
